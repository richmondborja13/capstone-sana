  ...
  return (
    <main id="home" className="relative">
      <div className="grid lg:grid-cols-2 min-h-[calc(100vh-80px)]">
        <div className="flex flex-col justify-center px-6 py-12 lg:px-12 relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-lg">
              <div className="flex-1">
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent text-gray-700 placeholder-gray-400"
                />
              </div>
        ...
        <div className="relative bg-blue-600 flex items-center justify-center">
          <div className="absolute inset-0 bg-blue-600"></div>

          <div className="relative z-10 w-full h-full flex items-center justify-center p-8">
            <div className="w-full max-w-md h-96 bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg shadow-2xl relative overflow-hidden">
